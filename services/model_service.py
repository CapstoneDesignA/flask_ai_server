...
class ModelService:
    ...
    test_gf_model = tf.keras.models.load_model('./model/test_sales_prediction_model.h5', custom_objects={'mse': mse})
    gf_model = tf.keras.models.load_model('./model/model_grandfa_v1.h5', custom_objects={'mse': mse})
    pho_model = tf.keras.models.load_model('./model/model_pho_v1.h5', custom_objects={'mse': mse})
    hello_model = tf.keras.models.load_model('./model/model_hello_v1.h5', custom_objects={'mse': mse})
